...
#     # This is where a request would be sent to an external authentication system for user verification.
#     # For this demo, we will pull the client json from secrets and verify the user.
